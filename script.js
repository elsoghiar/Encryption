...
window.Telegram.WebApp.setHeaderColor('#0C0C0C');
...
window.addEventListener('DOMContentLoaded', () => {
    const defaultButton = document.querySelector('button[data-target="mainPage"]');
    if (defaultButton) {
        defaultButton.classList.add('active'); 
        const defaultScreen = document.getElementById('mainPage'); 
        if (defaultScreen) {
